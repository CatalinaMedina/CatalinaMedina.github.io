...
- **Basic Statistics** (Stats 7) 2022 Summer Session: [`r fontawesome::fa(name = "desktop", fill = "blue")`](https://catalinamedina.github.io/uci-stats7-su22-website/)  
...
- **Intermediate Algebra** (Math 96) 2019 Summer:  
...
- **Elementary Algebra** (Math 95) 2019 Summer:  
...
## Teaching assistant  
### UCI  
- **Irvine Summer Institute in Biostatistics and Undergraduate Data Science (ISI-BUDS)**  2022 Summer: [`r fontawesome::fa(name = "link", fill = "blue")`](https://www.stat.uci.edu/isi-buds/)  
...
- **Statistical Methods for Data Analysis I** (Stats 110) 2021 Summer:  
...
- **Introduction to Probability and Statistics I** (Stats 120A) 2020 Summer:  
...
- **Introduction to Probability and Statistics for Computer Science** (Stats 67) 2020 Spring:  
Introduction to the basic concepts of probability and statistics with discussion of applications to computer science.  
- **Statistical Methods for Data Analysis II** (Stats 111) 2019 Winter:  
...
- **Introduction to Biological Statistics** (Stats 8) 2019 Fall:  
